        ...
        <div class="header-container">
            ...
            <nav class="header-nav">
                ...
                <ul>
                    ...
                    <li><a href="mailto:avindev777@gmail.com" title="Send me an email">.contact()</a></li>
                    <li class="social-link">
                        <a href="https://www.linkedin.com/in/avinin/" target="_blank" title="LinkedIn">
                    ...
                    <li class="social-link">
                        <a href="https://github.com/avinIndrasoma" target="_blank" title="GitHub">
